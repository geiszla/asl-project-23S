...
void fourtimesmultiplicationversion2(double *a0, double *b0, double *a1, double *b1, double *a2, double *b2, double *a3, double *b3, double *r0, double *r1, double *r2, double *r3, const int sizea, const int sizeb, const int sizer)
{
    ...
    int k = sizea;
    double *err0 = (double *)alloca(2*(sizea * sizea +3*sizea) * sizeof(double));
    double *err1 = (double *)alloca(2*(sizea * sizea +3*sizea) * sizeof(double));
    double *err2 = (double *)alloca(2*(sizea * sizea +3*sizea) * sizeof(double));
    double *err3 = (double *)alloca(2*(sizea * sizea +3*sizea) * sizeof(double));
    ...
    double *r_ext0 = (double *)alloca(2*(sizea * sizea  + sizea) * sizeof(double));
    double *r_ext1 = (double *)alloca(2*(sizea * sizea  + sizea) * sizeof(double));
    double *r_ext2 = (double *)alloca(2*(sizea * sizea  + sizea) * sizeof(double));
    double *r_ext3 = (double *)alloca(2*(sizea * sizea  + sizea) * sizeof(double));
